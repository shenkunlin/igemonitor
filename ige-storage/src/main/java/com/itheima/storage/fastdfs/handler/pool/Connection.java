...
import com.itheima.storage.fastdfs.handler.ProtoCommon;
...
public class Connection {
     ...
     * @throws IOException
     */
    public void close(ClientGlobal global) throws IOException {
        //if connection enabled get from connection pool
        if (global.g_connection_pool_enabled) {
    ...
    public void release(ClientGlobal clientGlobal) throws IOException {
