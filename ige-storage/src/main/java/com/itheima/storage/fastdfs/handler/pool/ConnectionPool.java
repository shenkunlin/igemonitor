...
public class ConnectionPool {
    ...
    public static Connection getConnection(InetSocketAddress socketAddress, ClientGlobal clientGlobal) throws MyException {
        ...
        return connectionManager.getConnection(clientGlobal);
    }
