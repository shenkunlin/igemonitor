...
public abstract class StructBase {
   ...
   */
  public abstract void setFields(byte[] bs, int offset, ClientGlobal clientGlobal);

  protected String stringValue(byte[] bs, int offset, FieldInfo filedInfo,ClientGlobal clientGlobal) {
    try {
