...
import com.itheima.storage.fastdfs.util.Base64;
...
public class StorageClient {
    ...
    public String[] upload_file(String local_filename, String file_ext_name,
                                NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        final String group_name = null;
        return this.upload_file(group_name, local_filename, file_ext_name, meta_list,clientGlobal);
    }
    ...
    protected String[] upload_file(String group_name, String local_filename, String file_ext_name,
        ...
        return this.upload_file(cmd, group_name, local_filename, file_ext_name, meta_list,clientGlobal);
    }
    ...
    protected String[] upload_file(byte cmd, String group_name, String local_filename, String file_ext_name,
        ...
        try {
            return this.do_upload_file(cmd, group_name, null, null, file_ext_name,
                    f.length(), new UploadStream(fis, f.length()), meta_list,clientGlobal);
        } finally {
            fis.close();
        }
    }
    ...
    public String[] upload_file(byte[] file_buff, int offset, int length, String file_ext_name,
                                NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        final String group_name = null;
        return this.upload_file(group_name, file_buff, offset, length, file_ext_name, meta_list,clientGlobal);
    }
    ...
    public String[] upload_file(String group_name, byte[] file_buff, int offset, int length,
                                String file_ext_name, NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, null, null, file_ext_name,
                length, new UploadBuff(file_buff, offset, length), meta_list,clientGlobal);
    }
    ...
    public String[] upload_file(byte[] file_buff, String file_ext_name,
                                NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        final String group_name = null;
        return this.upload_file(group_name, file_buff, 0, file_buff.length, file_ext_name, meta_list,clientGlobal);
    }
    ...
    public String[] upload_file(String group_name, byte[] file_buff,
                                String file_ext_name, NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, null, null, file_ext_name,
                file_buff.length, new UploadBuff(file_buff, 0, file_buff.length), meta_list,clientGlobal);
    }
    ...
    public String[] upload_file(String group_name, long file_size, UploadCallback callback,
        ...
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, master_filename, prefix_name,
                file_ext_name, file_size, callback, meta_list,clientGlobal);
    }
    ...
    public String[] upload_file(String group_name, String master_filename, String prefix_name,
                                String local_filename, String file_ext_name, NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        ...
        try {
            return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename, prefix_name,
                    file_ext_name, f.length(), new UploadStream(fis, f.length()), meta_list,clientGlobal);
        } finally {
            fis.close();
        }
    }
     ...
     */
    public String[] upload_file(String group_name, String master_filename, String prefix_name,
                                byte[] file_buff, String file_ext_name, NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        if ((group_name == null || group_name.length() == 0) ||
                (master_filename == null || master_filename.length() == 0) ||
                (prefix_name == null)) {
            throw new MyException("invalid arguement");
        ...
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename, prefix_name,
                file_ext_name, file_buff.length, new UploadBuff(file_buff, 0, file_buff.length), meta_list,clientGlobal);
    }
    ...
    public String[] upload_file(String group_name, String master_filename, String prefix_name,
        ...
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename, prefix_name,
                file_ext_name, length, new UploadBuff(file_buff, offset, length), meta_list,clientGlobal);
    }
    ...
    public String[] upload_appender_file(String local_filename, String file_ext_name,
                                         NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        final String group_name = null;
        return this.upload_appender_file(group_name, local_filename, file_ext_name, meta_list,clientGlobal);
    }
    ...
    public String[] upload_appender_file(byte[] file_buff, int offset, int length, String file_ext_name,
                                         NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        final String group_name = null;
        return this.upload_appender_file(group_name, file_buff, offset, length, file_ext_name, meta_list,clientGlobal);
    }
    ...
    public String[] upload_appender_file(byte[] file_buff, String file_ext_name,
                                         NameValuePair[] meta_list,ClientGlobal clientGlobal) throws IOException, MyException {
        final String group_name = null;
        return this.upload_appender_file(group_name, file_buff, 0, file_buff.length, file_ext_name, meta_list,clientGlobal);
    }
     ...
     */
    public int append_file(String group_name, String appender_filename, String local_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        File f = new File(local_filename);
        FileInputStream fis = new FileInputStream(f);

        try {
            return this.do_append_file(group_name, appender_filename, f.length(), new UploadStream(fis, f.length()),clientGlobal);
        } finally {
            fis.close();
        }
    }
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int append_file(String group_name, String appender_filename, byte[] file_buff,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_append_file(group_name, appender_filename, file_buff.length, new UploadBuff(file_buff, 0, file_buff.length),clientGlobal);
    }
    ...
    public int append_file(String group_name, String appender_filename,
                           byte[] file_buff, int offset, int length,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_append_file(group_name, appender_filename, length, new UploadBuff(file_buff, offset, length),clientGlobal);
    }
     ...
     */
    public int append_file(String group_name, String appender_filename,
                           long file_size, UploadCallback callback,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_append_file(group_name, appender_filename, file_size, callback,clientGlobal);
    }
    ...
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, String local_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        File f = new File(local_filename);
        FileInputStream fis = new FileInputStream(f);

        try {
            return this.do_modify_file(group_name, appender_filename, file_offset,
                    f.length(), new UploadStream(fis, f.length()),clientGlobal);
        } finally {
            fis.close();
        }
    }
     ...
     */
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, byte[] file_buff,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_modify_file(group_name, appender_filename, file_offset,
                file_buff.length, new UploadBuff(file_buff, 0, file_buff.length),clientGlobal);
    }
     ...
     */
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, byte[] file_buff, int buffer_offset, int buffer_length,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_modify_file(group_name, appender_filename, file_offset,
                buffer_length, new UploadBuff(file_buff, buffer_offset, buffer_length),clientGlobal);
    }
     ...
     */
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, long modify_size, UploadCallback callback,ClientGlobal clientGlobal) throws IOException, MyException {
        return this.do_modify_file(group_name, appender_filename, file_offset,
                modify_size, callback,clientGlobal);
    }
     ...
     * return null if fail
     */
    public String[] regenerate_appender_filename(String group_name, String appender_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        byte[] header;
        ...
        bNewStorageServer = this.newUpdatableStorageConnection(group_name, appender_filename,clientGlobal);

        try {
            connection = this.storageServer.getConnection(clientGlobal);
            ...
            releaseConnection(connection, bNewStorageServer,clientGlobal);
        }
    }
    ...
    protected String[] do_upload_file(byte cmd, String group_name, String master_filename,
        ...
        bUploadSlave = ((group_name != null && group_name.length() > 0) &&
                ...
                (prefix_name != null));
        if (bUploadSlave) {
            bNewStorageServer = this.newUpdatableStorageConnection(group_name, master_filename,clientGlobal);
        } else {
            bNewStorageServer = this.newWritableStorageConnection(group_name,clientGlobal);
        }
        ...
        try {
            ...
            try {
                result = this.set_metadata(new_group_name, remote_filename,
                        meta_list, ProtoCommon.STORAGE_SET_METADATA_FLAG_OVERWRITE,clientGlobal);
            } catch (IOException ex) {
                result = 5;
                throw ex;
            } finally {
                if (result != 0) {
                    ...
                    this.delete_file(new_group_name, remote_filename,clientGlobal);
                    return null;
                }
            }
            return results;
    ...
    private void releaseConnection(Connection connection, boolean bNewStorageServer,ClientGlobal clientGlobal) {
        try {
            if (connection != null) {
                connection.release(clientGlobal);
            }
        } catch (IOException ex1) {
            ex1.printStackTrace();
        } finally {
     ...
     */
    public int delete_file(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        boolean bNewStorageServer = this.newUpdatableStorageConnection(group_name, remote_filename,clientGlobal);
        Connection connection = this.storageServer.getConnection(clientGlobal);

        try {
            this.send_package(ProtoCommon.STORAGE_PROTO_CMD_DELETE_FILE, group_name, remote_filename, connection,clientGlobal);
            ProtoCommon.RecvPackageInfo pkgInfo = ProtoCommon.recvPackage(connection.getInputStream(),
                    ProtoCommon.STORAGE_PROTO_CMD_RESP, 0);
     ...
     * @return 0 for success, none zero for fail (error code)
     */
    public int truncate_file(String group_name, String appender_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        final long truncated_file_size = 0;
        return this.truncate_file(group_name, appender_filename, truncated_file_size,clientGlobal);
    }
    ...
    public int truncate_file(String group_name, String appender_filename,
                             long truncated_file_size,ClientGlobal clientGlobal) throws IOException, MyException {
        byte[] header;
        boolean bNewStorageServer;
        Connection connection = null;
        byte[] hexLenBytes;
     ...
     */
    public byte[] download_file(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        final long file_offset = 0;
        final long download_bytes = 0;

        return this.download_file(group_name, remote_filename, file_offset, download_bytes,clientGlobal);
    }
     ...
     * @return file content/buff, return null if fail
     */
    public byte[] download_file(String group_name, String remote_filename, long file_offset, long download_bytes,ClientGlobal clientGlobal) throws IOException, MyException {
        boolean bNewStorageServer = this.newReadableStorageConnection(group_name, remote_filename,clientGlobal);
        Connection connection = this.storageServer.getConnection(clientGlobal);

        try {
            ProtoCommon.RecvPackageInfo pkgInfo;

            this.send_download_package(group_name, remote_filename, file_offset, download_bytes, connection,clientGlobal);
    ...
    public int download_file(String group_name, String remote_filename,
                             String local_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        final long file_offset = 0;
        final long download_bytes = 0;
        return this.download_file(group_name, remote_filename,
                file_offset, download_bytes, local_filename,clientGlobal);
    }
     ...
     */
    public int download_file(String group_name, String remote_filename,
                             DownloadCallback callback,ClientGlobal clientGlobal) throws IOException, MyException {
        final long file_offset = 0;
        final long download_bytes = 0;
        return this.download_file(group_name, remote_filename,
                file_offset, download_bytes, callback,clientGlobal);
    }
     ...
     */
    public NameValuePair[] get_metadata(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        boolean bNewStorageServer = this.newUpdatableStorageConnection(group_name, remote_filename,clientGlobal);
        Connection connection = this.storageServer.getConnection(clientGlobal);
        try {
            ProtoCommon.RecvPackageInfo pkgInfo;

            this.send_package(ProtoCommon.STORAGE_PROTO_CMD_GET_METADATA, group_name, remote_filename, connection,clientGlobal);
            pkgInfo = ProtoCommon.recvPackage(connection.getInputStream(),
                    ProtoCommon.STORAGE_PROTO_CMD_RESP, -1);
    ...
    public int set_metadata(String group_name, String remote_filename,
                            NameValuePair[] meta_list, byte op_flag,ClientGlobal clientGlobal) throws IOException, MyException {
        boolean bNewStorageServer = this.newUpdatableStorageConnection(group_name, remote_filename,clientGlobal);
        Connection connection = this.storageServer.getConnection(clientGlobal);
        try {
            byte[] header;
     ...
     */
    public FileInfo get_file_info(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        ...
        if (file_type == FileInfo.FILE_TYPE_SLAVE ||
            ...
            FileInfo fi = this.query_file_info(group_name, remote_filename,clientGlobal);
            if (fi == null) {
                return null;
            }
     ...
     * @return FileInfo object for success, return null for fail
     */
    public FileInfo query_file_info(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        boolean bNewStorageServer = this.newUpdatableStorageConnection(group_name, remote_filename,clientGlobal);
        Connection connection = this.storageServer.getConnection(clientGlobal);
        try {
            byte[] header;
     ...
     */
    protected boolean newWritableStorageConnection(String group_name,ClientGlobal clientGlobal) throws IOException, MyException {
        if (this.storageServer != null) {
            return false;
        } else {
            TrackerClient tracker = new TrackerClient(clientGlobal);
            this.storageServer = tracker.getStoreStorage(this.trackerServer, group_name,clientGlobal);
            if (this.storageServer == null) {
     ...
     * @return true if create a new connection
     */
    protected boolean newReadableStorageConnection(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        if (this.storageServer != null) {
            return false;
        } else {
            TrackerClient tracker = new TrackerClient(clientGlobal);
            this.storageServer = tracker.getFetchStorage(this.trackerServer, group_name, remote_filename,clientGlobal);
            if (this.storageServer == null) {
                throw new MyException("getStoreStorage fail, errno code: " + tracker.getErrorCode());
            }
            return true;
     ...
     * @return true if create a new connection
     */
    protected boolean newUpdatableStorageConnection(String group_name, String remote_filename,ClientGlobal clientGlobal) throws IOException, MyException {
        if (this.storageServer != null) {
            return false;
        } else {
            TrackerClient tracker = new TrackerClient(clientGlobal);
            this.storageServer = tracker.getUpdateStorage(this.trackerServer, group_name, remote_filename,clientGlobal);
            if (this.storageServer == null) {
                throw new MyException("getStoreStorage fail, errno code: " + tracker.getErrorCode());
            }
            return true;
     ...
     * @param remote_filename filename on storage server
     */
    protected void send_package(byte cmd, String group_name, String remote_filename, Connection connection,ClientGlobal clientGlobal) throws IOException {
        byte[] header;
        byte[] groupBytes;
        byte[] filenameBytes;
        byte[] bs;
     ...
     */
    protected void send_download_package(String group_name, String remote_filename, long file_offset, long download_bytes, Connection connection,ClientGlobal clientGlobal) throws IOException {
        byte[] header;
        byte[] bsOffset;
        byte[] bsDownBytes;
        byte[] groupBytes;
