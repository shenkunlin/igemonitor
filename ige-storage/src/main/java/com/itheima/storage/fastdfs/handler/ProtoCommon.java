...
public class ProtoCommon {
   ...
   * @return token string
   */
  public static String getToken(String remote_filename, int ts, String secret_key,ClientGlobal clientGlobal) throws UnsupportedEncodingException, NoSuchAlgorithmException, MyException {
