...
import com.itheima.storage.fastdfs.util.IniFileReader;
...
public class ClientGlobal {
  ...
  public final String CONF_KEY_CONNECT_TIMEOUT = "connect_timeout";
  public final String CONF_KEY_NETWORK_TIMEOUT = "network_timeout";
  public final String CONF_KEY_CHARSET = "charset";
  public final String CONF_KEY_HTTP_ANTI_STEAL_TOKEN = "http.anti_steal_token";
  public final String CONF_KEY_HTTP_SECRET_KEY = "http.secret_key";
  public final String CONF_KEY_HTTP_TRACKER_HTTP_PORT = "http.tracker_http_port";
  public final String CONF_KEY_TRACKER_SERVER = "tracker_server";
  public final String PROP_KEY_CONNECT_TIMEOUT_IN_SECONDS = "fastdfs.connect_timeout_in_seconds";
  public final String PROP_KEY_NETWORK_TIMEOUT_IN_SECONDS = "fastdfs.network_timeout_in_seconds";
  public final String PROP_KEY_CHARSET = "fastdfs.charset";
  public final String PROP_KEY_HTTP_ANTI_STEAL_TOKEN = "fastdfs.http_anti_steal_token";
  public final String PROP_KEY_HTTP_SECRET_KEY = "fastdfs.http_secret_key";
  public final String PROP_KEY_HTTP_TRACKER_HTTP_PORT = "fastdfs.http_tracker_http_port";
  public final String PROP_KEY_TRACKER_SERVERS = "fastdfs.tracker_servers";


  public final String PROP_KEY_CONNECTION_POOL_ENABLED = "fastdfs.connection_pool.enabled";
  public final String PROP_KEY_CONNECTION_POOL_MAX_COUNT_PER_ENTRY = "fastdfs.connection_pool.max_count_per_entry";
  public final String PROP_KEY_CONNECTION_POOL_MAX_IDLE_TIME = "fastdfs.connection_pool.max_idle_time";
  public final String PROP_KEY_CONNECTION_POOL_MAX_WAIT_TIME_IN_MS = "fastdfs.connection_pool.max_wait_time_in_ms";
  ...
  public final boolean DEFAULT_HTTP_ANTI_STEAL_TOKEN = false;
  public final String DEFAULT_HTTP_SECRET_KEY = "FastDFS1234567890";
  public final int DEFAULT_HTTP_TRACKER_HTTP_PORT = 80;

  public final boolean DEFAULT_CONNECTION_POOL_ENABLED = true;
  public final int DEFAULT_CONNECTION_POOL_MAX_COUNT_PER_ENTRY = 100;
  public final int DEFAULT_CONNECTION_POOL_MAX_IDLE_TIME = 3600 ;//second
  public final int DEFAULT_CONNECTION_POOL_MAX_WAIT_TIME_IN_MS = 1000 ;//millisecond

  public int g_connect_timeout = DEFAULT_CONNECT_TIMEOUT * 1000; //millisecond
  public int g_network_timeout = DEFAULT_NETWORK_TIMEOUT * 1000; //millisecond
  public String g_charset = DEFAULT_CHARSET;
  public boolean g_anti_steal_token = DEFAULT_HTTP_ANTI_STEAL_TOKEN; //if anti-steal token
  public String g_secret_key = DEFAULT_HTTP_SECRET_KEY; //generage token secret key
  public int g_tracker_http_port = DEFAULT_HTTP_TRACKER_HTTP_PORT;

  public boolean g_connection_pool_enabled = DEFAULT_CONNECTION_POOL_ENABLED;
  public int g_connection_pool_max_count_per_entry = DEFAULT_CONNECTION_POOL_MAX_COUNT_PER_ENTRY;
  public int g_connection_pool_max_idle_time = DEFAULT_CONNECTION_POOL_MAX_IDLE_TIME * 1000; //millisecond
  public int g_connection_pool_max_wait_time_in_ms = DEFAULT_CONNECTION_POOL_MAX_WAIT_TIME_IN_MS; //millisecond
   ...
   */
  public ClientGlobal(Map<String,String> map) throws IOException, MyException {
    IniFileReader iniReader;
    String[] szTrackerServers;
    String[] parts;

    iniReader = new IniFileReader(map);
   ...
   *                      server之间用逗号','分隔
   */
  public void initByProperties(String propsFilePath) throws IOException, MyException {
  ...
  public void initByProperties(Properties props) throws IOException, MyException {
   ...
   *                       server之间用逗号','分隔
   */
  public void initByTrackers(String trackerServers) throws IOException, MyException {
  ...
  public void initByTrackers(InetSocketAddress[] trackerAddresses) throws IOException, MyException {
  ...
  public boolean isG_connection_pool_enabled() {
